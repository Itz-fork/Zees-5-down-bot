...
async def zee5_capture(bot, update):
    ...
    if "zee5" in update.text:
        ...
        await update.reply_text("Sorry!, but I can Download From **Zee5 Links Only!** 😔️. An Url Uploader Coming Soon... 😔️☺️", quote=True)
        return
    ...
    try:
        ...
        if t_response:
            ...
            await update.reply_text("Oh Boi!😮️ There is some issue with your URL 😢️ May be It's **DRM protected?** 🤔️", quote=True)
            return
    except:
        await update.reply_text("Oops.! Couldn't Download Your Video! 🤒️🤧️", quote=True)
